...
parser = argparse.ArgumentParser(description='Mamba & Transformer family for Time Series Forecasting')
...
parser.add_argument('--model', type=str, required=True, default='Mamba',
                    help='model name, options: [MambaFormer, AttMam, MamAtt, Mamba, DecoderOnly]')
...
if args.is_training:
    for ii in range(args.itr):
        ...
        setting = '{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_{}_{}_{}_{}_{}_{}_{}'.format(
            args.model_id,
            args.model,
            args.data,
            args.features,
